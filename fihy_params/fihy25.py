...
class FiHy25(Parameters):
    """
    A parameter class for FiHy25
    """
    ...
    def set_parameters(self):
        ...
        self.physical = {
            ...
            "E_f": 4e8,         
            # "lam_m": 1.50,    # default value from paper
            "lam_m": 3.8701,      # fitted to stress-strain w/ quartic dist
            "Psi_f": 1-0.24,
            "Phi_f": 0.77,
            "lam_z": 0.4,     # axial strain (-)
            "F": -10,         # applied force (N)
            "chi": 0.5680,       # fitted to stress-strain w/ J_h = 7
            "G_T":   G_T,
            ...
            "phi_0": 0.8224,     # initial porosity (-)
            "beta_r": 1,
            "beta_z": 1,

            # Experiment start/end times
            "t_start": 1e-6,    # start time (s)
            "t_end": 1e5,       # final time (s)
