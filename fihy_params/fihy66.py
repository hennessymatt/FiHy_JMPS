...
class FiHy66(Parameters):
    """
    A parameter class for FiHy66
    """
    ...
    def set_parameters(self):
        ...
        self.physical = {
            ...
            "E_f": 4e8,         
            # "lam_m": 1.50,
            "lam_m": 1.6526,      # fitted to stress-strain w/ quartic dist
            "Psi_f": 1-0.50,
            "Phi_f": 0.51,
            "lam_z": 0.4,     # axial strain (-)
            "F": -10,         # applied force (N)
            "chi": 0.5665,       # fitted to stress-strain w/ J_h = 7
            "G_T":   G_T,
